...
echo "   - Subdomain: $(terraform output -raw cdn_domain)"
echo "   - Target: Get exact value from Yandex Cloud Console → CDN → DNS settings"
echo ""
echo "2. Credentials exported to deploy/.env (if you selected 'yes')"
echo ""
